...
describe("SwipeableCard", () => {
  ...
  it("アニメーション完了後にロックが解除され連続スワイプできる", () => {
    ...
    renderWithClient(<SwipeableCard ref={ref} item={mockTrack} isTop onSwipe={onSwipe} index={0} />);
  ...
  it("キーボード操作でもロックが解除される", () => {
    ...
    renderWithClient(<SwipeableCard item={mockTrack} isTop onSwipe={onSwipe} index={0} />);
